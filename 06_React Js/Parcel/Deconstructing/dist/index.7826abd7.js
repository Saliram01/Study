...
const App = ()=>{
    return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", null, /*#__PURE__*/ (0, _reactDefault.default).createElement("h2", {
        style: {
            textAlign: 'center',
            color: 'green'
        }
...
exports.default = App;
(0, _reactDom.render)(/*#__PURE__*/ (0, _reactDefault.default).createElement(App, null), document.getElementById('root'));

},{"./react":"4ZG9e","./react-dom":"brZxE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./App.css":"7g3a6"}],"4ZG9e":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"brZxE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function render(reactElement, rootElement) {
    function createDOMElement(reactElement) {
        ...
        Object.entries(props).forEach(([key, value])=>{
            if (key === 'style') Object.entries(value).forEach(([style, value])=>{
    ...
    if (Array.isArray(DOMElement)) rootElement.append(...DOMElement);
    else rootElement.append(DOMElement);
}
exports.default = {
    render
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7g3a6":[function() {},{}]},["4qlNF","2Ew96"], "2Ew96", "parcelRequire94c2")

...
let initialState = {
    products: (0, _productListDefault.default),
    cartItems: [],
    wishList: []
};
...
function reducer(state = initialState, action) {
    switch(action.type){
        ...
        case 'CART_REMOVE_ITEM':
            return {
                ...state,
                cartItems: state.cartItems.filter((cartList)=>cartList.productId !== action.payload.productId)
            };
        ...
        case 'WISHLIST_REMOVE_ITEM':
            return {
                ...state,
                wishList: state.wishList.filter((wList)=>wList.productId !== action.payload.productId)
            };
        default:
            return state;
    }
...
},{"redux":"anWnS","./productList":"dCC0l","@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{}],"dCC0l":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const products = [
    {

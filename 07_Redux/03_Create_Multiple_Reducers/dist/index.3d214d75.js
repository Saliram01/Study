...
// Cart Add
store.dispatch({
    type: (0, _cartReducer.CARD_ADD_ITEMS),
    payload: {
        productId: 1,
        quantity: 1
    }
...
store.dispatch({
    type: (0, _cartReducer.CART_INCREASE_ITEM_QUANTITY),
    payload: {
        productId: 2
    }
});
...
store.dispatch({
    type: (0, _cartReducer.CART_DECREASE_ITEM_QUANTITY),
    payload: {
        productId: 3
    }
});
// WishList Add
store.dispatch({
    type: (0, _wishListReducer.WISHLIST_ADD_ITEMS),
    payload: {
        productId: 1
    }
});
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CARD_ADD_ITEMS", ()=>CARD_ADD_ITEMS);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WISHLIST_ADD_ITEMS", ()=>WISHLIST_ADD_ITEMS);

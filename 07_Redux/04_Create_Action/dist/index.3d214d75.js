...
})({"8zdJK":[function(require,module,exports,__globalThis) {
...
// Cart Add
store.dispatch((0, _cartReducer.addCartItems)(1, 1));
store.dispatch((0, _cartReducer.addCartItems)(2, 1));
store.dispatch((0, _cartReducer.addCartItems)(3, 1));
// Cart Remove
store.dispatch((0, _cartReducer.cartRemove)(3));
// Increase Cart Quantity
store.dispatch((0, _cartReducer.increaseCartItemQuantity)(2));
store.dispatch((0, _cartReducer.increaseCartItemQuantity)(2));
store.dispatch((0, _cartReducer.increaseCartItemQuantity)(3));
// Decrease Cart Quantity
store.dispatch((0, _cartReducer.decreaseCartItemQuantity)(3));
// WishList Add
store.dispatch((0, _wishListReducer.addWishList)(1));
store.dispatch((0, _wishListReducer.addWishList)(12));
store.dispatch((0, _wishListReducer.addWishList)(122));
// WishList Remove
store.dispatch((0, _wishListReducer.removeWishList)(12));
store.dispatch((0, _wishListReducer.removeWishList)(122));
console.log(store.getState());

},{"redux":"anWnS","./cartReducer":"96Hwp","./wishListReducer":"eKMDw","./productsReducer":"9nz3D","@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"nYuhQ":[function(require,module,exports,__globalThis) {
...
},{}],"96Hwp":[function(require,module,exports,__globalThis) {
// Action types
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Action creaters
parcelHelpers.export(exports, "addCartItems", ()=>addCartItems);
...
parcelHelpers.export(exports, "cartRemove", ()=>cartRemove);
...
function addCartItems(productId, quantity) {
    return {
        type: CARD_ADD_ITEMS,
        payload: {
            productId,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"eKMDw":[function(require,module,exports,__globalThis) {
// Action type
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Action creater
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"9nz3D":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function productReducer(state = (0, _productListDefault.default)) {
    return state;
}

},{"./productList":"dCC0l","@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}],"dCC0l":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const products = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"nYuhQ"}]},["8zdJK","bB7Pu"], "bB7Pu", "parcelRequire94c2")
